...
const double R[3][3]={{0.00421931,-0.58970284,0.80760928},{-0.99956488,-0.0260642,-0.01380947},{0.02919317,-0.80719961,-0.58955623}};//旋转矩阵 由标定得到
const double T[3]={0.242235785887492, 0.0357624525677812, 0.18254923291985084};//平移矩阵 由标定得到
